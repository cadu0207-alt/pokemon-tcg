...
const CARDS_ME05 = [
  ...
  {n:'004',dex:754,artist:'5ban Graphics',name:'Lurantis ex',type:'Grama',color:'#4CAF50',rare:'Rara Dupla',price:2.00,base:true},
  {n:'005',dex:1012,artist:'Mousho',name:'Poltchageist',type:'Trevas',color:'#212121',rare:'Comum',price:0.14,base:true},
  {n:'006',dex:1013,artist:'mingo',name:'Sinistcha',type:'Trevas',color:'#212121',rare:'Incomum',price:0.19,base:true},
  ...
  {n:'031',dex:80,name:'Mega Slowbro ex',type:'Psiquico',color:'#9C27B0',rare:'Rara Dupla',price:3.50,base:true},
  ...
  {n:'045',dex:409,artist:'GOSSAN',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:2.63,base:true},
  ...
  {n:'048',dex:491,name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Rara Dupla',price:6.00,base:true},
  ...
  {n:'054',dex:828,artist:'Naoki Saito',name:'Thievul',type:'Trevas',color:'#212121',rare:'Incomum',price:0.10,base:true},
  {n:'055',dex:877,artist:'Krgc',name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Dupla',price:2.85,base:true},
  ...
  {n:'065',dex:530,artist:'Saboteri',name:'Mega Excadrill ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:5.00,base:true},
  {n:'066',dex:731,artist:'Uta',name:'Pikipek',type:'Incolor',color:'#9E9E9E',rare:'Comum',price:0.11,base:true},
  {n:'067',dex:732,artist:'Keisuke Azuma',name:'Trumbeak',type:'Incolor',color:'#9E9E9E',rare:'Comum',price:0.11,base:true},
  ...
  {n:'070',dex:773,artist:'Masako Tomii',name:'Silvally',type:'Incolor',color:'#9E9E9E',rare:'Rara',price:0.17,base:true},
  ...
  {n:'075',artist:'Takumi Wada',name:'Dark Bell',type:'Treinador',color:'#607D8B',rare:'Incomum',price:0.19,base:true},
  {n:'076',artist:'GIDORA',name:'Fossil Excavation Site',type:'Treinador',color:'#607D8B',rare:'Incomum',price:0.10,base:true},
  {n:'077',artist:'Oswaldo KATO',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Incomum',price:0.10,base:true},
  {n:'078',artist:'nagimiso',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Incomum',price:0.20,base:true},
  {n:'079',name:'Jett',type:'Treinador',color:'#607D8B',rare:'Incomum',price:0.01,base:true},
  {n:'080',artist:'Toyste Beach',name:"Misty's Cheerfulness",type:'Treinador',color:'#607D8B',rare:'Incomum',price:0.10,base:true},
  {n:'081',artist:'akagi',name:'Rust Syndicate Grunt',type:'Treinador',color:'#607D8B',rare:'Incomum',price:0.01,base:true},
  {n:'082',artist:'AYUMI ODASHIMA',name:'Terrific Bomb',type:'Treinador',color:'#607D8B',rare:'Incomum',price:0.10,base:true},
  {n:'083',artist:'Teeziro',name:'Shadowy Darkness Energy',type:'Energia',color:'#212121',rare:'Rara',price:0.40,base:true},
  ...
  {n:'085',dex:753,artist:'inose yukie',name:'Fomantis',type:'Grama',color:'#4CAF50',rare:'Rara Ilustrada',price:4.90,base:false},
  {n:'086',dex:936,name:'Armarouge',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada',price:20.00,base:false},
  {n:'087',dex:118,name:'Goldeen',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:54.00,base:false},
  {n:'088',dex:730,artist:'Jiro Sasumo',name:'Primarina',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:21.90,base:false},
  {n:'089',dex:310,artist:'Iwamoto05',name:'Manectric',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada',price:9.90,base:false},
  {n:'090',dex:80,artist:'Gemi',name:'Slowbro',type:'Psiquico',color:'#9C27B0',rare:'Rara Ilustrada',price:43.00,base:false},
  {n:'091',dex:781,artist:'satoma',name:'Dhelmise',type:'Grama',color:'#4CAF50',rare:'Rara Ilustrada',price:16.99,base:false},
  {n:'092',dex:828,artist:'HICO KIM',name:'Thievul',type:'Trevas',color:'#212121',rare:'Rara Ilustrada',price:8.90,base:false},
  {n:'093',dex:411,artist:'Nakamura Ippan',name:'Bastiodon',type:'Metal',color:'#607D8B',rare:'Rara Ilustrada',price:11.90,base:false},
  {n:'094',dex:733,artist:'Jerky',name:'Toucannon',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:23.00,base:false},
  {n:'095',dex:773,artist:'Yoriyuki Ikegami',name:'Silvally',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:14.90,base:false},
  {n:'096',dex:754,artist:'miki kudo',name:'Lurantis ex',type:'Grama',color:'#4CAF50',rare:'Ultra Rara',price:8.40,base:false},
  {n:'097',dex:321,artist:'DOM',name:'Wailord ex',type:'Agua',color:'#2196F3',rare:'Ultra Rara',price:15.25,base:false},
  {n:'098',dex:807,artist:'5ban Graphics',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Ultra Rara',price:20.90,base:false},
  {n:'099',dex:609,artist:'5ban Graphics',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Ultra Rara',price:32.50,base:false},
  {n:'100',dex:409,artist:'5ban Graphics',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Ultra Rara',price:12.90,base:false},
  {n:'101',dex:491,artist:'5ban Graphics',name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Ultra Rara',price:45.00,base:false},
  {n:'102',dex:877,artist:'5ban Graphics',name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Ultra Rara',price:10.00,base:false},
  {n:'103',dex:530,artist:'5ban Graphics',name:'Mega Excadrill ex',type:'Luta',color:'#FF6B35',rare:'Ultra Rara',price:24.99,base:false},
  {n:'104',name:'Bracelete Bravio',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:22.90,base:false},
  {n:'105',artist:'Toyste Beach',name:'Martelo Esmagador',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:28.67,base:false},
  {n:'106',artist:'Ayaka Yoshida',name:'Dark Bell',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:11.88,base:false},
  {n:'107',artist:'Keisuke Azuma',name:'Substituicao de Energia',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:14.90,base:false},
  {n:'108',artist:'nagimiso',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:27.80,base:false},
  {n:'109',artist:'En Morikura',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:53.80,base:false},
  {n:'110',artist:'5ban Graphics',name:'Defensor Ferreo',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:8.00,base:false},
  {n:'111',artist:'akagi',name:"Misty's Spirit (Energia da Misty)",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:112.00,base:false},
  {n:'112',artist:'Studio Bora Inc.',name:'Rust Syndicate Grunt',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:11.90,base:false},
  {n:'113',name:'Splendid Bomb',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:10.80,base:false},
  {n:'114',dex:807,artist:'Teeziro',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:199.41,base:false},
  {n:'115',dex:609,artist:'inose yukie',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada Especial',price:170.00,base:false},
  ...
  {n:'117',dex:877,name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:209.90,base:false},
  {n:'118',artist:'AKIRA EGAWA',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Rara Ilustrada Especial',price:129.00,base:false},
  {n:'119',artist:'NG Empire',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Rara Ilustrada Especial',price:185.00,base:false},
  {n:'120',dex:491,artist:'DOM',name:'Mega Darkrai ex Gold',type:'Trevas',color:'#212121',rare:'Hiper Rara Mega',price:825.00,base:false},
];
