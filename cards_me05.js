...
const CARDS_ME05 = [
  ...
  {n:'004',dex:754,artist:'5ban Graphics',name:'Lurantis ex',type:'Grama',color:'#4CAF50',rare:'Rara Dupla',price:2.50,base:true},
  ...
  {n:'008',dex:655,name:'Mega Delphox ex',type:'Fogo',color:'#F44336',rare:'Rara Dupla',price:3.80,base:true},
  {n:'009',dex:850,artist:'5ban Graphics',name:'Sizzlipede',type:'Fogo',color:'#F44336',rare:'Comum',price:0.10,base:true},
  ...
  {n:'016',dex:321,artist:'Asako Ito',name:'Wailord ex',type:'Agua',color:'#2196F3',rare:'Rara Dupla',price:2.40,base:true},
  ...
  {n:'019',dex:729,artist:'Oswaldo KATO',name:'Brionne',type:'Agua',color:'#2196F3',rare:'Comum',price:0.10,base:true},
  ...
  {n:'029',dex:79,artist:'mashu',name:'Slowpoke',type:'Psiquico',color:'#9C27B0',rare:'Comum',price:0.10,base:true},
  {n:'030',dex:80,artist:'Nelnal',name:'Slowbro',type:'Psiquico',color:'#9C27B0',rare:'Incomum',price:0.10,base:true},
  {n:'031',dex:80,name:'Mega Slowbro ex',type:'Psiquico',color:'#9C27B0',rare:'Rara Dupla',price:0.20,base:true},
  {n:'032',dex:124,artist:'CHORISO',name:'Jynx',type:'Psiquico',color:'#9C27B0',rare:'Comum',price:0.10,base:true},
  {n:'033',dex:353,artist:'5ban Graphics',name:'Shuppet',type:'Trevas',color:'#212121',rare:'Comum',price:0.10,base:true},
  {n:'034',dex:354,artist:'Yoshimoto Yoshimon',name:'Banette',type:'Trevas',color:'#212121',rare:'Incomum',price:0.10,base:true},
  ...
  {n:'037',dex:608,artist:'danciao',name:'Lampent',type:'Fogo',color:'#F44336',rare:'Incomum',price:0.14,base:true},
  {n:'038',dex:609,artist:'HYOGONOSUKE',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Rara Dupla',price:4.99,base:true},
  {n:'039',dex:781,artist:'sowsow',name:'Dhelmise',type:'Grama',color:'#4CAF50',rare:'Incomum',price:0.10,base:true},
  ...
  {n:'045',dex:409,artist:'GOSSAN',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:2.85,base:true},
  ...
  {n:'048',dex:491,name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Rara Dupla',price:7.92,base:true},
  ...
  {n:'055',dex:877,artist:'Krgc',name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Dupla',price:3.20,base:true},
  {n:'056',dex:893,artist:'GOTO minori',name:'Zarude',type:'Trevas',color:'#212121',rare:'Rara',price:0.20,base:true},
  ...
  {n:'061',dex:410,artist:'IKEDA Saki',name:'Shieldon',type:'Metal',color:'#607D8B',rare:'Comum',price:0.10,base:true},
  ...
  {n:'065',dex:530,artist:'Saboteri',name:'Mega Excadrill ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:2.00,base:true},
  ...
  {n:'068',dex:733,artist:'Koji Nakata',name:'Toucannon',type:'Incolor',color:'#9E9E9E',rare:'Incomum',price:0.10,base:true},
  {n:'069',dex:772,name:'Tipo Nulo',type:'Incolor',color:'#9E9E9E',rare:'Comum',price:0.10,base:true},
  {n:'070',dex:773,artist:'Masako Tomii',name:'Silvally',type:'Incolor',color:'#9E9E9E',rare:'Rara',price:0.15,base:true},
  ...
  {n:'083',artist:'Teeziro',name:'Shadowy Darkness Energy',type:'Energia',color:'#212121',rare:'Rara',price:0.49,base:true},
  {n:'084',artist:'En Morikura',name:'Voltaic Lightning Energy',type:'Energia',color:'#FFC107',rare:'Rara',price:0.39,base:true},
  ...
  {n:'085',dex:753,artist:'inose yukie',name:'Fomantis',type:'Grama',color:'#4CAF50',rare:'Rara Ilustrada',price:13.86,base:false},
  {n:'086',dex:936,name:'Armarouge',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada',price:18.80,base:false},
  {n:'087',dex:118,name:'Goldeen',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:45.90,base:false},
  {n:'088',dex:730,artist:'Jiro Sasumo',name:'Primarina',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:18.62,base:false},
  {n:'089',dex:310,artist:'Iwamoto05',name:'Manectric',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada',price:11.99,base:false},
  {n:'090',dex:80,artist:'Gemi',name:'Slowbro',type:'Psiquico',color:'#9C27B0',rare:'Rara Ilustrada',price:48.51,base:false},
  {n:'091',dex:781,artist:'satoma',name:'Dhelmise',type:'Grama',color:'#4CAF50',rare:'Rara Ilustrada',price:27.00,base:false},
  {n:'092',dex:828,artist:'HICO KIM',name:'Thievul',type:'Trevas',color:'#212121',rare:'Rara Ilustrada',price:7.44,base:false},
  {n:'093',dex:411,artist:'Nakamura Ippan',name:'Bastiodon',type:'Metal',color:'#607D8B',rare:'Rara Ilustrada',price:14.00,base:false},
  {n:'094',dex:733,artist:'Jerky',name:'Toucannon',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:29.90,base:false},
  {n:'095',dex:773,artist:'Yoriyuki Ikegami',name:'Silvally',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:17.46,base:false},
  {n:'096',dex:754,artist:'miki kudo',name:'Lurantis ex',type:'Grama',color:'#4CAF50',rare:'Ultra Rara',price:9.50,base:false},
  {n:'097',dex:321,artist:'DOM',name:'Wailord ex',type:'Agua',color:'#2196F3',rare:'Ultra Rara',price:16.79,base:false},
  {n:'098',dex:807,artist:'5ban Graphics',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Ultra Rara',price:22.00,base:false},
  {n:'099',dex:609,artist:'5ban Graphics',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Ultra Rara',price:32.90,base:false},
  {n:'100',dex:409,artist:'5ban Graphics',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Ultra Rara',price:16.90,base:false},
  {n:'101',dex:491,artist:'5ban Graphics',name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Ultra Rara',price:57.75,base:false},
  {n:'102',dex:877,artist:'5ban Graphics',name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Ultra Rara',price:4.99,base:false},
  {n:'103',dex:530,artist:'5ban Graphics',name:'Mega Excadrill ex',type:'Luta',color:'#FF6B35',rare:'Ultra Rara',price:30.00,base:false},
  {n:'104',name:'Bracelete Bravio',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:30.00,base:false},
  {n:'105',artist:'Toyste Beach',name:'Martelo Esmagador',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:33.89,base:false},
  {n:'106',artist:'Ayaka Yoshida',name:'Dark Bell',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:14.55,base:false},
  {n:'107',artist:'Keisuke Azuma',name:'Substituicao de Energia',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:17.75,base:false},
  {n:'108',artist:'nagimiso',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:19.00,base:false},
  {n:'109',artist:'En Morikura',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:54.90,base:false},
  {n:'110',artist:'5ban Graphics',name:'Defensor Ferreo',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:9.00,base:false},
  {n:'111',artist:'akagi',name:"Misty's Spirit (Energia da Misty)",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:115.00,base:false},
  {n:'112',artist:'Studio Bora Inc.',name:'Rust Syndicate Grunt',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:14.50,base:false},
  {n:'113',name:'Splendid Bomb',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:13.40,base:false},
  {n:'114',dex:807,artist:'Teeziro',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:247.90,base:false},
  {n:'115',dex:609,artist:'inose yukie',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada Especial',price:195.00,base:false},
  {n:'116',dex:491,artist:'GIDORA',name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Rara Ilustrada Especial',price:879.90,base:false},
  {n:'117',dex:877,name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:260.00,base:false},
  {n:'118',artist:'AKIRA EGAWA',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Rara Ilustrada Especial',price:129.90,base:false},
  {n:'119',artist:'NG Empire',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Rara Ilustrada Especial',price:160.00,base:false},
  {n:'120',dex:491,artist:'DOM',name:'Mega Darkrai ex Gold',type:'Trevas',color:'#212121',rare:'Hiper Rara Mega',price:849.89,base:false},
];
