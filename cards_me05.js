...
const CARDS_ME05 = [
  ...
  {n:'008',dex:655,name:'Mega Delphox ex',type:'Fogo',color:'#F44336',rare:'Rara Dupla',price:3.49,base:true},
  ...
  {n:'045',dex:409,artist:'GOSSAN',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:2.45,base:true},
  ...
  {n:'055',dex:877,artist:'Krgc',name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Dupla',price:2.89,base:true},
  ...
  {n:'086',dex:936,name:'Armarouge',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada',price:18.90,base:false},
  ...
  {n:'089',dex:310,artist:'Iwamoto05',name:'Manectric',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada',price:10.89,base:false},
  {n:'090',dex:80,artist:'Gemi',name:'Slowbro',type:'Psiquico',color:'#9C27B0',rare:'Rara Ilustrada',price:46.50,base:false},
  ...
  {n:'094',dex:733,artist:'Jerky',name:'Toucannon',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:26.90,base:false},
  ...
  {n:'103',dex:530,artist:'5ban Graphics',name:'Mega Excadrill ex',type:'Luta',color:'#FF6B35',rare:'Ultra Rara',price:31.60,base:false},
  {n:'104',name:'Bracelete Bravio',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:27.45,base:false},
  {n:'105',artist:'Toyste Beach',name:'Martelo Esmagador',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:29.90,base:false},
  {n:'106',artist:'Ayaka Yoshida',name:'Dark Bell',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:13.00,base:false},
  {n:'107',artist:'Keisuke Azuma',name:'Substituicao de Energia',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:18.60,base:false},
  {n:'108',artist:'nagimiso',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:23.99,base:false},
  {n:'109',artist:'En Morikura',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:54.99,base:false},
  ...
  {n:'114',dex:807,artist:'Teeziro',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:240.00,base:false},
  {n:'115',dex:609,artist:'inose yukie',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada Especial',price:180.00,base:false},
  {n:'116',dex:491,artist:'GIDORA',name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Rara Ilustrada Especial',price:849.90,base:false},
  {n:'117',dex:877,name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:250.00,base:false},
  {n:'118',artist:'AKIRA EGAWA',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Rara Ilustrada Especial',price:127.99,base:false},
  {n:'119',artist:'NG Empire',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Rara Ilustrada Especial',price:160.00,base:false},
  {n:'120',dex:491,artist:'DOM',name:'Mega Darkrai ex Gold',type:'Trevas',color:'#212121',rare:'Hiper Rara Mega',price:750.00,base:false},
];
