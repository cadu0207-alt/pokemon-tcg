...
const CARDS_ME05 = [
  ...
  {n:'027',dex:807,artist:'KEIICHIRO ITO',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Rara Dupla',price:3.60,base:true},
  ...
  {n:'030',dex:80,artist:'Nelnal',name:'Slowbro',type:'Psiquico',color:'#9C27B0',rare:'Incomum',price:0.11,base:true},
  ...
  {n:'034',dex:354,artist:'Yoshimoto Yoshimon',name:'Banette',type:'Trevas',color:'#212121',rare:'Incomum',price:0.13,base:true},
  ...
  {n:'045',dex:409,artist:'GOSSAN',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:2.00,base:true},
  ...
  {n:'065',dex:530,artist:'Saboteri',name:'Mega Excadrill ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:6.00,base:true},
  ...
  {n:'085',dex:753,artist:'inose yukie',name:'Fomantis',type:'Grama',color:'#4CAF50',rare:'Rara Ilustrada',price:14.50,base:false},
  {n:'086',dex:936,name:'Armarouge',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada',price:18.79,base:false},
  {n:'087',dex:118,name:'Goldeen',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:54.00,base:false},
  {n:'088',dex:730,artist:'Jiro Sasumo',name:'Primarina',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:21.50,base:false},
  {n:'089',dex:310,artist:'Iwamoto05',name:'Manectric',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada',price:11.90,base:false},
  {n:'090',dex:80,artist:'Gemi',name:'Slowbro',type:'Psiquico',color:'#9C27B0',rare:'Rara Ilustrada',price:46.80,base:false},
  ...
  {n:'093',dex:411,artist:'Nakamura Ippan',name:'Bastiodon',type:'Metal',color:'#607D8B',rare:'Rara Ilustrada',price:12.49,base:false},
  {n:'094',dex:733,artist:'Jerky',name:'Toucannon',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:23.90,base:false},
  {n:'095',dex:773,artist:'Yoriyuki Ikegami',name:'Silvally',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:14.98,base:false},
  {n:'096',dex:754,artist:'miki kudo',name:'Lurantis ex',type:'Grama',color:'#4CAF50',rare:'Ultra Rara',price:9.90,base:false},
  {n:'097',dex:321,artist:'DOM',name:'Wailord ex',type:'Agua',color:'#2196F3',rare:'Ultra Rara',price:14.90,base:false},
  {n:'098',dex:807,artist:'5ban Graphics',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Ultra Rara',price:21.00,base:false},
  {n:'099',dex:609,artist:'5ban Graphics',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Ultra Rara',price:30.00,base:false},
  {n:'100',dex:409,artist:'5ban Graphics',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Ultra Rara',price:13.90,base:false},
  {n:'101',dex:491,artist:'5ban Graphics',name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Ultra Rara',price:42.90,base:false},
  {n:'102',dex:877,artist:'5ban Graphics',name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Ultra Rara',price:4.99,base:false},
  {n:'103',dex:530,artist:'5ban Graphics',name:'Mega Excadrill ex',type:'Luta',color:'#FF6B35',rare:'Ultra Rara',price:31.25,base:false},
  {n:'104',name:'Bracelete Bravio',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:22.90,base:false},
  {n:'105',artist:'Toyste Beach',name:'Martelo Esmagador',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:23.90,base:false},
  {n:'106',artist:'Ayaka Yoshida',name:'Dark Bell',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:12.50,base:false},
  {n:'107',artist:'Keisuke Azuma',name:'Substituicao de Energia',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:15.49,base:false},
  {n:'108',artist:'nagimiso',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:22.50,base:false},
  {n:'109',artist:'En Morikura',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:53.70,base:false},
  ...
  {n:'112',artist:'Studio Bora Inc.',name:'Rust Syndicate Grunt',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:10.80,base:false},
  {n:'113',name:'Splendid Bomb',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:10.80,base:false},
  {n:'114',dex:807,artist:'Teeziro',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:219.90,base:false},
  ...
  {n:'118',artist:'AKIRA EGAWA',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Rara Ilustrada Especial',price:129.60,base:false},
  {n:'119',artist:'NG Empire',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Rara Ilustrada Especial',price:190.00,base:false},
  {n:'120',dex:491,artist:'DOM',name:'Mega Darkrai ex Gold',type:'Trevas',color:'#212121',rare:'Hiper Rara Mega',price:837.00,base:false},
];
