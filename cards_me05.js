...
const CARDS_ME05 = [
  ...
  {n:'004',dex:754,artist:'5ban Graphics',name:'Lurantis ex',type:'Grama',color:'#4CAF50',rare:'Rara Dupla',price:2.48,base:true},
  ...
  {n:'008',dex:655,name:'Mega Delphox ex',type:'Fogo',color:'#F44336',rare:'Rara Dupla',price:3.60,base:true},
  ...
  {n:'027',dex:807,artist:'KEIICHIRO ITO',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Rara Dupla',price:4.25,base:true},
  ...
  {n:'031',dex:80,name:'Mega Slowbro ex',type:'Psiquico',color:'#9C27B0',rare:'Rara Dupla',price:3.78,base:true},
  ...
  {n:'045',dex:409,artist:'GOSSAN',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:2.80,base:true},
  ...
  {n:'055',dex:877,artist:'Krgc',name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Dupla',price:3.40,base:true},
  ...
  {n:'065',dex:530,artist:'Saboteri',name:'Mega Excadrill ex',type:'Luta',color:'#FF6B35',rare:'Rara Dupla',price:5.90,base:true},
  ...
  {n:'084',artist:'En Morikura',name:'Voltaic Lightning Energy',type:'Energia',color:'#FFC107',rare:'Rara',price:0.40,base:true},
  ...
  {n:'085',dex:753,artist:'inose yukie',name:'Fomantis',type:'Grama',color:'#4CAF50',rare:'Rara Ilustrada',price:14.00,base:false},
  {n:'086',dex:936,name:'Armarouge',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada',price:18.70,base:false},
  {n:'087',dex:118,name:'Goldeen',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:50.26,base:false},
  {n:'088',dex:730,artist:'Jiro Sasumo',name:'Primarina',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:17.99,base:false},
  {n:'089',dex:310,artist:'Iwamoto05',name:'Manectric',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada',price:11.00,base:false},
  {n:'090',dex:80,artist:'Gemi',name:'Slowbro',type:'Psiquico',color:'#9C27B0',rare:'Rara Ilustrada',price:49.00,base:false},
  {n:'091',dex:781,artist:'satoma',name:'Dhelmise',type:'Grama',color:'#4CAF50',rare:'Rara Ilustrada',price:26.98,base:false},
  {n:'092',dex:828,artist:'HICO KIM',name:'Thievul',type:'Trevas',color:'#212121',rare:'Rara Ilustrada',price:6.86,base:false},
  {n:'093',dex:411,artist:'Nakamura Ippan',name:'Bastiodon',type:'Metal',color:'#607D8B',rare:'Rara Ilustrada',price:12.99,base:false},
  {n:'094',dex:733,artist:'Jerky',name:'Toucannon',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:29.00,base:false},
  {n:'095',dex:773,artist:'Yoriyuki Ikegami',name:'Silvally',type:'Incolor',color:'#9E9E9E',rare:'Rara Ilustrada',price:10.00,base:false},
  {n:'096',dex:754,artist:'miki kudo',name:'Lurantis ex',type:'Grama',color:'#4CAF50',rare:'Ultra Rara',price:8.90,base:false},
  {n:'097',dex:321,artist:'DOM',name:'Wailord ex',type:'Agua',color:'#2196F3',rare:'Ultra Rara',price:16.00,base:false},
  {n:'098',dex:807,artist:'5ban Graphics',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Ultra Rara',price:21.90,base:false},
  {n:'099',dex:609,artist:'5ban Graphics',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Ultra Rara',price:32.90,base:false},
  {n:'100',dex:409,artist:'5ban Graphics',name:'Rampardos ex',type:'Luta',color:'#FF6B35',rare:'Ultra Rara',price:16.15,base:false},
  {n:'101',dex:491,artist:'5ban Graphics',name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Ultra Rara',price:57.60,base:false},
  ...
  {n:'105',artist:'Toyste Beach',name:'Martelo Esmagador',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:31.90,base:false},
  {n:'106',artist:'Ayaka Yoshida',name:'Dark Bell',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:13.58,base:false},
  {n:'107',artist:'Keisuke Azuma',name:'Substituicao de Energia',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:18.62,base:false},
  {n:'108',artist:'nagimiso',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:23.00,base:false},
  {n:'109',artist:'En Morikura',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:54.45,base:false},
  {n:'110',artist:'5ban Graphics',name:'Defensor Ferreo',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:9.00,base:false},
  {n:'111',artist:'akagi',name:"Misty's Spirit (Energia da Misty)",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:114.00,base:false},
  ...
  {n:'113',name:'Splendid Bomb',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:13.00,base:false},
  {n:'114',dex:807,artist:'Teeziro',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:246.00,base:false},
  {n:'115',dex:609,artist:'inose yukie',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada Especial',price:190.00,base:false},
  {n:'116',dex:491,artist:'GIDORA',name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Rara Ilustrada Especial',price:864.00,base:false},
  {n:'117',dex:877,name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:259.88,base:false},
  ...
  {n:'120',dex:491,artist:'DOM',name:'Mega Darkrai ex Gold',type:'Trevas',color:'#212121',rare:'Hiper Rara Mega',price:799.00,base:false},
];
