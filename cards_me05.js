...
const CARDS_ME05 = [
  ...
  {n:'086',dex:936,name:'Armarouge',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada',price:19.75,base:false},
  {n:'087',dex:118,name:'Goldeen',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:54.00,base:false},
  {n:'088',dex:730,artist:'Jiro Sasumo',name:'Primarina',type:'Agua',color:'#2196F3',rare:'Rara Ilustrada',price:19.85,base:false},
  {n:'089',dex:310,artist:'Iwamoto05',name:'Manectric',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada',price:11.00,base:false},
  {n:'090',dex:80,artist:'Gemi',name:'Slowbro',type:'Psiquico',color:'#9C27B0',rare:'Rara Ilustrada',price:49.85,base:false},
  {n:'091',dex:781,artist:'satoma',name:'Dhelmise',type:'Grama',color:'#4CAF50',rare:'Rara Ilustrada',price:24.85,base:false},
  ...
  {n:'105',artist:'Toyste Beach',name:'Martelo Esmagador',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:28.90,base:false},
  {n:'106',artist:'Ayaka Yoshida',name:'Dark Bell',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:12.00,base:false},
  {n:'107',artist:'Keisuke Azuma',name:'Substituicao de Energia',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:15.89,base:false},
  {n:'108',artist:'nagimiso',name:"Gladion's Showdown",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:23.99,base:false},
  {n:'109',artist:'En Morikura',name:'Gwynn',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:52.90,base:false},
  {n:'110',artist:'5ban Graphics',name:'Defensor Ferreo',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:6.93,base:false},
  {n:'111',artist:'akagi',name:"Misty's Spirit (Energia da Misty)",type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:99.90,base:false},
  ...
  {n:'113',name:'Splendid Bomb',type:'Treinador',color:'#607D8B',rare:'Ultra Rara',price:11.89,base:false},
  {n:'114',dex:807,artist:'Teeziro',name:'Mega Zeraora ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:224.67,base:false},
  {n:'115',dex:609,artist:'inose yukie',name:'Mega Chandelure ex',type:'Fogo',color:'#F44336',rare:'Rara Ilustrada Especial',price:175.00,base:false},
  {n:'116',dex:491,artist:'GIDORA',name:'Mega Darkrai ex',type:'Trevas',color:'#212121',rare:'Rara Ilustrada Especial',price:838.00,base:false},
  {n:'117',dex:877,name:'Morpeko ex',type:'Eletrico',color:'#FFC107',rare:'Rara Ilustrada Especial',price:249.89,base:false},
  ...
  {n:'120',dex:491,artist:'DOM',name:'Mega Darkrai ex Gold',type:'Trevas',color:'#212121',rare:'Hiper Rara Mega',price:784.90,base:false},
];
