...
const CARDS_MEP = [
  ...
  {n:'002',name:'Inteleon',type:'Aquático',color:'#2196F3',rare:'Promo (Staff)',price:7.74,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'008',name:'Golduck',type:'Aquático',color:'#2196F3',rare:'Promo',price:0.80,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'015',name:'Zacian',type:'Psíquico',color:'#9C27B0',rare:'Promo (Staff)',price:8.99,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'023',name:'Mega Charizard X ex',type:'Fogo',color:'#F44336',rare:'Promo (UPC)',price:105.00,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'029',name:'Mega Charizard X ex',type:'Fogo',color:'#F44336',rare:'Promo (Tin)',price:17.50,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'032',name:'Mega Gardevoir ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Poster)',price:45.07,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'034',name:'Mega Meganium ex',type:'Grama',color:'#4CAF50',rare:'Promo (Jumbo)',price:6.30,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'035',name:'Mega Emboar ex',type:'Fogo',color:'#F44336',rare:'Promo (Jumbo)',price:6.50,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'036',name:'Mega Feraligatr ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:7.65,base:false,important:true,series:'Promos MEP 001–036'},
  // SÉRIE 1 — Kanto (MEP037–039)
  // Charmander > Bulbasaur > Squirtle em popularidade; referência USD: ~$44/$37/$34
  {n:'037',name:'Bulbasaur',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:77.00,base:true,important:true,series:'Série 1 — Kanto'},
  {n:'038',name:'Charmander',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:100.00,base:true,important:true,series:'Série 1 — Kanto'},
  {n:'039',name:'Squirtle',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:69.00,base:true,important:true,series:'Série 1 — Kanto'},
  // SÉRIE 1 — Sinnoh (MEP040–042)
  // Piplup > Chimchar > Turtwig; Piplup tem maior fanbase
  {n:'040',name:'Turtwig',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:28.90,base:true,series:'Série 1 — Sinnoh'},
  {n:'041',name:'Chimchar',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:34.50,base:true,series:'Série 1 — Sinnoh'},
  ...
  {n:'044',name:'Litten',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:24.49,base:true,series:'Série 1 — Alola'},
  ...
  {n:'047',name:'Cyndaquil',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:57.00,base:true,important:true,series:'Série 2 — Johto'},
  {n:'048',name:'Totodile',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:59.90,base:true,series:'Série 2 — Johto'},
  // SÉRIE 2 — Unova (MEP049–051)
  // Snivy e Oshawott têm fanbases fortes; Gen 5 em alta; Tepig menor demanda
  {n:'049',name:'Snivy',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:39.50,base:true,series:'Série 2 — Unova'},
  {n:'050',name:'Tepig',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:34.49,base:true,series:'Série 2 — Unova'},
  {n:'051',name:'Oshawott',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:34.50,base:true,series:'Série 2 — Unova'},
  ...
  {n:'054',name:'Sobble',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:30.99,base:true,series:'Série 2 — Galar'},
  ...
  {n:'055',name:'Treecko',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:44.00,base:true,series:'Série 3 — Hoenn'},
  {n:'056',name:'Torchic',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:44.00,base:true,series:'Série 3 — Hoenn'},
  {n:'057',name:'Mudkip',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:44.00,base:true,important:true,series:'Série 3 — Hoenn'},
  {n:'058',name:'Chespin',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:42.80,base:true,series:'Série 3 — Kalos'},
  {n:'059',name:'Fennekin',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:41.80,base:true,important:true,series:'Série 3 — Kalos'},
  {n:'060',name:'Froakie',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:41.80,base:true,series:'Série 3 — Kalos'},
  {n:'061',name:'Sprigatito',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:42.90,base:true,important:true,series:'Série 3 — Paldea'},
  {n:'062',name:'Fuecoco',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:42.90,base:true,series:'Série 3 — Paldea'},
  {n:'063',name:'Quaxly',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:42.90,base:true,series:'Série 3 — Paldea'},
  ...
  {n:'064',name:'Serperior',type:'Grama',color:'#4CAF50',rare:'Promo (Staff)',price:9.31,base:false,series:'Promos MEP 064–081'},
  {n:'065',name:'Barbaracle',type:'Lutador',color:'#795548',rare:'Promo (Staff)',price:11.64,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'070',name:'Tyrunt',type:'Lutador',color:'#795548',rare:'Promo (Pokémon Center)',price:24.00,base:false,series:'Promos MEP 064–081'},
  {n:'071',name:'Mega Zygarde ex',type:'Lutador',color:'#795548',rare:'Promo (Jumbo)',price:13.30,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'075',name:'Ampharos',type:'Raio',color:'#FFC107',rare:'Promo (B&B)',price:10.00,base:false,series:'Promos MEP 064–081'},
  {n:'076',name:'Crobat',type:'Escuridão',color:'#212121',rare:'Promo (B&B)',price:14.99,base:false,series:'Promos MEP 064–081'},
  {n:'077',name:'Goodra',type:'Dragão',color:'#7C4DFF',rare:'Promo (B&B)',price:14.99,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'081',name:'Mega Greninja ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:34.89,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'082',name:'Miraidon',type:'Raio',color:'#FFC107',rare:'Promo (Jumbo)',price:22.49,base:false,important:true,series:'Promos MEP 082–110'},
  ...
  {n:'087',name:'Binacle',type:'Lutador',color:'#795548',rare:'Promo (Blister)',price:0.75,base:false,series:'Promos MEP 082–110'},
  {n:'088',name:'Zarude',type:'Escuridão',color:'#212121',rare:'Promo (Pokémon Center)',price:24.00,base:false,series:'Promos MEP 082–110'},
