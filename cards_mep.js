...
const CARDS_MEP = [
  ...
  {n:'002',name:'Inteleon',type:'Aquático',color:'#2196F3',rare:'Promo (Staff)',price:7.03,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'009',name:'Alakazam',type:'Psíquico',color:'#9C27B0',rare:'Promo (Pokémon Center)',price:119.99,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'014',name:'Ceruledge',type:'Fogo',color:'#F44336',rare:'Promo (Staff)',price:13.20,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'017',name:'Toxtricity',type:'Escuridão',color:'#212121',rare:'Promo (Staff)',price:17.99,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'033',name:'Mega Lucario ex',type:'Lutador',color:'#795548',rare:'Promo (Poster)',price:71.49,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'034',name:'Mega Meganium ex',type:'Grama',color:'#4CAF50',rare:'Promo (Jumbo)',price:7.50,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'035',name:'Mega Emboar ex',type:'Fogo',color:'#F44336',rare:'Promo (Jumbo)',price:8.50,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'036',name:'Mega Feraligatr ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:8.99,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'040',name:'Turtwig',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:31.31,base:true,series:'Série 1 — Sinnoh'},
  ...
  {n:'044',name:'Litten',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:27.90,base:true,series:'Série 1 — Alola'},
  {n:'045',name:'Popplio',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:27.00,base:true,series:'Série 1 — Alola'},
  ...
  {n:'046',name:'Chikorita',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:54.99,base:true,series:'Série 2 — Johto'},
  {n:'047',name:'Cyndaquil',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:59.00,base:true,important:true,series:'Série 2 — Johto'},
  ...
  {n:'049',name:'Snivy',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:46.95,base:true,series:'Série 2 — Unova'},
  {n:'050',name:'Tepig',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:44.90,base:true,series:'Série 2 — Unova'},
  {n:'051',name:'Oshawott',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:45.99,base:true,series:'Série 2 — Unova'},
  // SÉRIE 2 — Galar (MEP052–054)
  // Menos nostalgia; Sobble tem maior seguimento individual; os três são os mais baratos da S2
  {n:'052',name:'Grookey',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:34.90,base:true,series:'Série 2 — Galar'},
  {n:'053',name:'Scorbunny',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:33.85,base:true,series:'Série 2 — Galar'},
  {n:'054',name:'Sobble',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:32.80,base:true,series:'Série 2 — Galar'},
  ...
  {n:'055',name:'Treecko',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:90.00,base:true,series:'Série 3 — Hoenn'},
  {n:'056',name:'Torchic',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:89.99,base:true,series:'Série 3 — Hoenn'},
  {n:'057',name:'Mudkip',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:109.00,base:true,important:true,series:'Série 3 — Hoenn'},
  {n:'058',name:'Chespin',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:99.00,base:true,series:'Série 3 — Kalos'},
  {n:'059',name:'Fennekin',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:99.00,base:true,important:true,series:'Série 3 — Kalos'},
  {n:'060',name:'Froakie',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:99.99,base:true,series:'Série 3 — Kalos'},
  {n:'061',name:'Sprigatito',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:99.99,base:true,important:true,series:'Série 3 — Paldea'},
  {n:'062',name:'Fuecoco',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:99.99,base:true,series:'Série 3 — Paldea'},
  {n:'063',name:'Quaxly',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:99.99,base:true,series:'Série 3 — Paldea'},
  ...
  {n:'067',name:'Doublade',type:'Metal',color:'#9E9E9E',rare:'Promo (Staff)',price:9.80,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'070',name:'Tyrunt',type:'Lutador',color:'#795548',rare:'Promo (Pokémon Center)',price:25.00,base:false,series:'Promos MEP 064–081'},
  {n:'071',name:'Mega Zygarde ex',type:'Lutador',color:'#795548',rare:'Promo (Jumbo)',price:20.70,base:false,important:true,series:'Promos MEP 064–081'},
  {n:'072',name:'Mega Clefable ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Jumbo)',price:24.90,base:false,important:true,series:'Promos MEP 064–081'},
  {n:'073',name:'Mega Gengar ex',type:'Escuridão',color:'#212121',rare:'Promo (Jumbo)',price:36.00,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'077',name:'Goodra',type:'Dragão',color:'#7C4DFF',rare:'Promo (B&B)',price:16.30,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'082',name:'Miraidon',type:'Raio',color:'#FFC107',rare:'Promo (Jumbo)',price:28.99,base:false,important:true,series:'Promos MEP 082–110'},
