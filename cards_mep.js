...
const CARDS_MEP = [
  ...
  {n:'001',name:'Meganium',type:'Grama',color:'#4CAF50',rare:'Promo (Staff)',price:34.64,base:false,series:'Promos MEP 001–036'},
  {n:'002',name:'Inteleon',type:'Aquático',color:'#2196F3',rare:'Promo (Staff)',price:7.67,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'010',name:'Riolu',type:'Lutador',color:'#795548',rare:'Promo (Pokémon Center)',price:99.00,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'012',name:'Mega Lucario ex',type:'Lutador',color:'#795548',rare:'Promo (Jumbo)',price:8.90,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'016',name:'Flygon',type:'Lutador',color:'#795548',rare:'Promo (Staff)',price:11.78,base:false,series:'Promos MEP 001–036'},
  {n:'017',name:'Toxtricity',type:'Escuridão',color:'#212121',rare:'Promo (Staff)',price:17.81,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'023',name:'Mega Charizard X ex',type:'Fogo',color:'#F44336',rare:'Promo (UPC)',price:109.00,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'024',name:'Oricorio ex',type:'Fogo',color:'#F44336',rare:'Promo (UPC)',price:26.90,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'027',name:'Haunter',type:'Escuridão',color:'#212121',rare:'Promo',price:61.66,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'030',name:'Mega Charizard Y ex',type:'Fogo',color:'#F44336',rare:'Promo (Tin)',price:19.50,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'031',name:"N's Zekrom",type:'Raio',color:'#FFC107',rare:'Promo (Pokémon Center)',price:49.34,base:false,series:'Promos MEP 001–036'},
  {n:'032',name:'Mega Gardevoir ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Poster)',price:41.00,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'034',name:'Mega Meganium ex',type:'Grama',color:'#4CAF50',rare:'Promo (Jumbo)',price:9.00,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'035',name:'Mega Emboar ex',type:'Fogo',color:'#F44336',rare:'Promo (Jumbo)',price:9.00,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'036',name:'Mega Feraligatr ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:9.00,base:false,important:true,series:'Promos MEP 001–036'},
  // SÉRIE 1 — Kanto (MEP037–039)
  // Charmander > Bulbasaur > Squirtle em popularidade; referência USD: ~$44/$37/$34
  {n:'037',name:'Bulbasaur',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:74.00,base:true,important:true,series:'Série 1 — Kanto'},
  {n:'038',name:'Charmander',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:93.98,base:true,important:true,series:'Série 1 — Kanto'},
  {n:'039',name:'Squirtle',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:67.90,base:true,important:true,series:'Série 1 — Kanto'},
  ...
  {n:'044',name:'Litten',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:29.43,base:true,series:'Série 1 — Alola'},
  ...
  {n:'047',name:'Cyndaquil',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:55.00,base:true,important:true,series:'Série 2 — Johto'},
  {n:'048',name:'Totodile',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:60.99,base:true,series:'Série 2 — Johto'},
  // SÉRIE 2 — Unova (MEP049–051)
  // Snivy e Oshawott têm fanbases fortes; Gen 5 em alta; Tepig menor demanda
  {n:'049',name:'Snivy',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:41.00,base:true,series:'Série 2 — Unova'},
  {n:'050',name:'Tepig',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:44.00,base:true,series:'Série 2 — Unova'},
  {n:'051',name:'Oshawott',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:45.00,base:true,series:'Série 2 — Unova'},
  ...
  {n:'053',name:'Scorbunny',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:30.00,base:true,series:'Série 2 — Galar'},
  {n:'054',name:'Sobble',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:34.00,base:true,series:'Série 2 — Galar'},
  ...
  {n:'068',name:'Makuhita',type:'Lutador',color:'#795548',rare:'Promo',price:0.98,base:false,series:'Promos MEP 064–081'},
  {n:'069',name:'Chikorita',type:'Grama',color:'#4CAF50',rare:'Promo',price:0.75,base:false,series:'Promos MEP 064–081'},
  {n:'070',name:'Tyrunt',type:'Lutador',color:'#795548',rare:'Promo (Pokémon Center)',price:22.00,base:false,series:'Promos MEP 064–081'},
  {n:'071',name:'Mega Zygarde ex',type:'Lutador',color:'#795548',rare:'Promo (Jumbo)',price:23.75,base:false,important:true,series:'Promos MEP 064–081'},
  {n:'072',name:'Mega Clefable ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Jumbo)',price:38.00,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'074',name:'Delphox',type:'Fogo',color:'#F44336',rare:'Promo (B&B)',price:20.00,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'080',name:'Fennekin',type:'Fogo',color:'#F44336',rare:'Promo',price:29.90,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'082',name:'Miraidon',type:'Raio',color:'#FFC107',rare:'Promo (Jumbo)',price:32.00,base:false,important:true,series:'Promos MEP 082–110'},
  {n:'083',name:'Slowbro',type:'Psíquico',color:'#9C27B0',rare:'Promo (B&B)',price:19.50,base:false,series:'Promos MEP 082–110'},
  {n:'084',name:'Dhelmise',type:'Psíquico',color:'#9C27B0',rare:'Promo (B&B)',price:35.00,base:false,series:'Promos MEP 082–110'},
  {n:'085',name:'Bastiodon',type:'Metal',color:'#9E9E9E',rare:'Promo (Staff)',price:22.50,base:false,series:'Promos MEP 082–110'},
