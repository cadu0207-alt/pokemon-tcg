...
const CARDS_MEP = [
  ...
  {n:'009',name:'Alakazam',type:'Psíquico',color:'#9C27B0',rare:'Promo (Pokémon Center)',price:100.00,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'024',name:'Oricorio ex',type:'Fogo',color:'#F44336',rare:'Promo (UPC)',price:27.00,base:false,series:'Promos MEP 001–036'},
  {n:'025',name:'Mega Kangaskhan ex',type:'Incolor',color:'#9E9E9E',rare:'Promo (Jumbo)',price:9.75,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'032',name:'Mega Gardevoir ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Poster)',price:39.90,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'034',name:'Mega Meganium ex',type:'Grama',color:'#4CAF50',rare:'Promo (Jumbo)',price:7.00,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'035',name:'Mega Emboar ex',type:'Fogo',color:'#F44336',rare:'Promo (Jumbo)',price:7.49,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'038',name:'Charmander',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:99.90,base:true,important:true,series:'Série 1 — Kanto'},
  ...
  {n:'040',name:'Turtwig',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:29.00,base:true,series:'Série 1 — Sinnoh'},
  ...
  {n:'043',name:'Rowlet',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:25.75,base:true,series:'Série 1 — Alola'},
  {n:'044',name:'Litten',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:24.49,base:true,series:'Série 1 — Alola'},
  {n:'045',name:'Popplio',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:26.10,base:true,series:'Série 1 — Alola'},
  ...
  {n:'047',name:'Cyndaquil',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:57.90,base:true,important:true,series:'Série 2 — Johto'},
  {n:'048',name:'Totodile',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:62.90,base:true,series:'Série 2 — Johto'},
  // SÉRIE 2 — Unova (MEP049–051)
  // Snivy e Oshawott têm fanbases fortes; Gen 5 em alta; Tepig menor demanda
  {n:'049',name:'Snivy',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:43.99,base:true,series:'Série 2 — Unova'},
  {n:'050',name:'Tepig',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:42.50,base:true,series:'Série 2 — Unova'},
  {n:'051',name:'Oshawott',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:41.99,base:true,series:'Série 2 — Unova'},
  ...
  {n:'053',name:'Scorbunny',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:29.89,base:true,series:'Série 2 — Galar'},
  {n:'054',name:'Sobble',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:31.90,base:true,series:'Série 2 — Galar'},
  ...
  {n:'055',name:'Treecko',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:47.00,base:true,series:'Série 3 — Hoenn'},
  {n:'056',name:'Torchic',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:47.00,base:true,series:'Série 3 — Hoenn'},
  {n:'057',name:'Mudkip',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:47.00,base:true,important:true,series:'Série 3 — Hoenn'},
  {n:'058',name:'Chespin',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:47.00,base:true,series:'Série 3 — Kalos'},
  {n:'059',name:'Fennekin',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:47.00,base:true,important:true,series:'Série 3 — Kalos'},
  {n:'060',name:'Froakie',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:47.00,base:true,series:'Série 3 — Kalos'},
  {n:'061',name:'Sprigatito',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:47.00,base:true,important:true,series:'Série 3 — Paldea'},
  {n:'062',name:'Fuecoco',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:47.00,base:true,series:'Série 3 — Paldea'},
  {n:'063',name:'Quaxly',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:47.00,base:true,series:'Série 3 — Paldea'},
  ...
  {n:'067',name:'Doublade',type:'Metal',color:'#9E9E9E',rare:'Promo (Staff)',price:8.75,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'071',name:'Mega Zygarde ex',type:'Lutador',color:'#795548',rare:'Promo (Jumbo)',price:14.00,base:false,important:true,series:'Promos MEP 064–081'},
  {n:'072',name:'Mega Clefable ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Jumbo)',price:23.74,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'081',name:'Mega Greninja ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:38.00,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'085',name:'Bastiodon',type:'Metal',color:'#9E9E9E',rare:'Promo (Staff)',price:22.00,base:false,series:'Promos MEP 082–110'},
  ...
  {n:'086',name:'Slowpoke',type:'Psíquico',color:'#9C27B0',rare:'Promo (Blister)',price:1.50,base:false,series:'Promos MEP 082–110'},
