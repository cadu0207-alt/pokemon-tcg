...
const CARDS_MEP = [
  ...
  {n:'001',name:'Meganium',type:'Grama',color:'#4CAF50',rare:'Promo (Staff)',price:34.00,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'004',name:'Lunatone',type:'Lutador',color:'#795548',rare:'Promo (Staff)',price:35.00,base:false,series:'Promos MEP 001–036'},
  {n:'005',name:'Drifloon',type:'Psíquico',color:'#9C27B0',rare:'Promo',price:0.41,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'008',name:'Golduck',type:'Aquático',color:'#2196F3',rare:'Promo',price:0.63,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'013',name:'Mega Venusaur ex',type:'Grama',color:'#4CAF50',rare:'Promo (Jumbo)',price:4.90,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'016',name:'Flygon',type:'Lutador',color:'#795548',rare:'Promo (Staff)',price:11.70,base:false,series:'Promos MEP 001–036'},
  {n:'017',name:'Toxtricity',type:'Escuridão',color:'#212121',rare:'Promo (Staff)',price:18.00,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'027',name:'Haunter',type:'Escuridão',color:'#212121',rare:'Promo',price:130.00,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'031',name:"N's Zekrom",type:'Raio',color:'#FFC107',rare:'Promo (Pokémon Center)',price:59.90,base:false,series:'Promos MEP 001–036'},
  {n:'032',name:'Mega Gardevoir ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Poster)',price:32.19,base:false,important:true,series:'Promos MEP 001–036'},
  ...
  {n:'036',name:'Mega Feraligatr ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:6.50,base:false,important:true,series:'Promos MEP 001–036'},
  // SÉRIE 1 — Kanto (MEP037–039)
  // Charmander > Bulbasaur > Squirtle em popularidade; referência USD: ~$44/$37/$34
  {n:'037',name:'Bulbasaur',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:98.95,base:true,important:true,series:'Série 1 — Kanto'},
  ...
  {n:'039',name:'Squirtle',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:89.85,base:true,important:true,series:'Série 1 — Kanto'},
  ...
  {n:'041',name:'Chimchar',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:32.90,base:true,series:'Série 1 — Sinnoh'},
  ...
  {n:'043',name:'Rowlet',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:27.90,base:true,series:'Série 1 — Alola'},
  {n:'044',name:'Litten',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:26.10,base:true,series:'Série 1 — Alola'},
  {n:'045',name:'Popplio',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:24.30,base:true,series:'Série 1 — Alola'},
  ...
  {n:'046',name:'Chikorita',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:54.00,base:true,series:'Série 2 — Johto'},
  ...
  {n:'049',name:'Snivy',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:41.40,base:true,series:'Série 2 — Unova'},
  {n:'050',name:'Tepig',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:33.30,base:true,series:'Série 2 — Unova'},
  {n:'051',name:'Oshawott',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:37.00,base:true,series:'Série 2 — Unova'},
  ...
  {n:'058',name:'Chespin',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:33.90,base:true,series:'Série 3 — Kalos'},
  ...
  {n:'062',name:'Fuecoco',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:35.99,base:true,series:'Série 3 — Paldea'},
  {n:'063',name:'Quaxly',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:36.00,base:true,series:'Série 3 — Paldea'},
  ...
  {n:'065',name:'Barbaracle',type:'Lutador',color:'#795548',rare:'Promo (Staff)',price:11.90,base:false,series:'Promos MEP 064–081'},
  {n:'066',name:'Tyrantrum',type:'Lutador',color:'#795548',rare:'Promo (Staff)',price:14.30,base:false,series:'Promos MEP 064–081'},
  {n:'067',name:'Doublade',type:'Metal',color:'#9E9E9E',rare:'Promo (Staff)',price:7.20,base:false,series:'Promos MEP 064–081'},
  {n:'068',name:'Makuhita',type:'Lutador',color:'#795548',rare:'Promo',price:0.81,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'073',name:'Mega Gengar ex',type:'Escuridão',color:'#212121',rare:'Promo (Jumbo)',price:26.60,base:false,important:true,series:'Promos MEP 064–081'},
  {n:'074',name:'Delphox',type:'Fogo',color:'#F44336',rare:'Promo (B&B)',price:13.99,base:false,series:'Promos MEP 064–081'},
  {n:'075',name:'Ampharos',type:'Raio',color:'#FFC107',rare:'Promo (B&B)',price:12.00,base:false,series:'Promos MEP 064–081'},
  {n:'076',name:'Crobat',type:'Escuridão',color:'#212121',rare:'Promo (B&B)',price:17.77,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'081',name:'Mega Greninja ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:29.50,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'082',name:'Miraidon',type:'Raio',color:'#FFC107',rare:'Promo (Jumbo)',price:18.60,base:false,important:true,series:'Promos MEP 082–110'},
  {n:'083',name:'Slowbro',type:'Psíquico',color:'#9C27B0',rare:'Promo (B&B)',price:27.00,base:false,series:'Promos MEP 082–110'},
  {n:'084',name:'Dhelmise',type:'Psíquico',color:'#9C27B0',rare:'Promo (B&B)',price:38.90,base:false,series:'Promos MEP 082–110'},
  {n:'085',name:'Bastiodon',type:'Metal',color:'#9E9E9E',rare:'Promo (Staff)',price:21.20,base:false,series:'Promos MEP 082–110'},
  ...
  {n:'088',name:'Zarude',type:'Escuridão',color:'#212121',rare:'Promo (Pokémon Center)',price:15.00,base:false,series:'Promos MEP 082–110'},
  ...
  {n:'093',name:'Pikachu',type:'Raio',color:'#FFC107',rare:'Promo',price:99.99,base:false,series:'Promos MEP 082–110'},
