...
const CARDS_MEP = [
  ...
  {n:'024',name:'Oricorio ex',type:'Fogo',color:'#F44336',rare:'Promo (UPC)',price:28.31,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'044',name:'Litten',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:25.51,base:true,series:'Série 1 — Alola'},
  ...
  {n:'049',name:'Snivy',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:44.10,base:true,series:'Série 2 — Unova'},
  {n:'050',name:'Tepig',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:43.00,base:true,series:'Série 2 — Unova'},
  {n:'051',name:'Oshawott',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:42.00,base:true,series:'Série 2 — Unova'},
  ...
  {n:'055',name:'Treecko',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:59.50,base:true,series:'Série 3 — Hoenn'},
  {n:'056',name:'Torchic',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:59.50,base:true,series:'Série 3 — Hoenn'},
  {n:'057',name:'Mudkip',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:59.50,base:true,important:true,series:'Série 3 — Hoenn'},
  {n:'058',name:'Chespin',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:59.50,base:true,series:'Série 3 — Kalos'},
  {n:'059',name:'Fennekin',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:59.50,base:true,important:true,series:'Série 3 — Kalos'},
  {n:'060',name:'Froakie',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:59.50,base:true,series:'Série 3 — Kalos'},
  {n:'061',name:'Sprigatito',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:59.50,base:true,important:true,series:'Série 3 — Paldea'},
  {n:'062',name:'Fuecoco',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:59.50,base:true,series:'Série 3 — Paldea'},
  {n:'063',name:'Quaxly',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:59.50,base:true,series:'Série 3 — Paldea'},
  ...
  {n:'081',name:'Mega Greninja ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:25.00,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'086',name:'Slowpoke',type:'Psíquico',color:'#9C27B0',rare:'Promo (Blister)',price:25.00,base:false,series:'Promos MEP 082–110'},
  {n:'087',name:'Binacle',type:'Lutador',color:'#795548',rare:'Promo (Blister)',price:27.00,base:false,series:'Promos MEP 082–110'},
  {n:'088',name:'Zarude',type:'Escuridão',color:'#212121',rare:'Promo (Pokémon Center)',price:55.00,base:false,series:'Promos MEP 082–110'},
