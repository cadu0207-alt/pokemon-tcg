...
const CARDS_MEP = [
  ...
  {n:'010',name:'Riolu',type:'Lutador',color:'#795548',rare:'Promo (Pokémon Center)',price:109.90,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'020',name:'Sneasel',type:'Escuridão',color:'#212121',rare:'Promo',price:0.39,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'024',name:'Oricorio ex',type:'Fogo',color:'#F44336',rare:'Promo (UPC)',price:29.89,base:false,series:'Promos MEP 001–036'},
  ...
  {n:'032',name:'Mega Gardevoir ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Poster)',price:35.90,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'033',name:'Mega Lucario ex',type:'Lutador',color:'#795548',rare:'Promo (Poster)',price:50.00,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'034',name:'Mega Meganium ex',type:'Grama',color:'#4CAF50',rare:'Promo (Jumbo)',price:6.90,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'035',name:'Mega Emboar ex',type:'Fogo',color:'#F44336',rare:'Promo (Jumbo)',price:7.35,base:false,important:true,series:'Promos MEP 001–036'},
  {n:'036',name:'Mega Feraligatr ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:8.00,base:false,important:true,series:'Promos MEP 001–036'},
  // SÉRIE 1 — Kanto (MEP037–039)
  // Charmander > Bulbasaur > Squirtle em popularidade; referência USD: ~$44/$37/$34
  {n:'037',name:'Bulbasaur',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:73.99,base:true,important:true,series:'Série 1 — Kanto'},
  {n:'038',name:'Charmander',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:99.80,base:true,important:true,series:'Série 1 — Kanto'},
  {n:'039',name:'Squirtle',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:68.90,base:true,important:true,series:'Série 1 — Kanto'},
  ...
  {n:'041',name:'Chimchar',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:29.90,base:true,series:'Série 1 — Sinnoh'},
  ...
  {n:'043',name:'Rowlet',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:26.99,base:true,series:'Série 1 — Alola'},
  ...
  {n:'047',name:'Cyndaquil',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:56.90,base:true,important:true,series:'Série 2 — Johto'},
  ...
  {n:'049',name:'Snivy',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:33.90,base:true,series:'Série 2 — Unova'},
  {n:'050',name:'Tepig',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:33.90,base:true,series:'Série 2 — Unova'},
  ...
  {n:'053',name:'Scorbunny',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:29.50,base:true,series:'Série 2 — Galar'},
  {n:'054',name:'Sobble',type:'Aquático',color:'#2196F3',rare:'Ilustração Rara (IR)',price:31.84,base:true,series:'Série 2 — Galar'},
  ...
  {n:'056',name:'Torchic',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:43.90,base:true,series:'Série 3 — Hoenn'},
  ...
  {n:'058',name:'Chespin',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:43.00,base:true,series:'Série 3 — Kalos'},
  {n:'059',name:'Fennekin',type:'Fogo',color:'#F44336',rare:'Ilustração Rara (IR)',price:43.00,base:true,important:true,series:'Série 3 — Kalos'},
  {n:'060',name:'Froakie',type:'Incolor',color:'#9E9E9E',rare:'Ilustração Rara (IR)',price:43.00,base:true,series:'Série 3 — Kalos'},
  {n:'061',name:'Sprigatito',type:'Grama',color:'#4CAF50',rare:'Ilustração Rara (IR)',price:44.00,base:true,important:true,series:'Série 3 — Paldea'},
  ...
  {n:'065',name:'Barbaracle',type:'Lutador',color:'#795548',rare:'Promo (Staff)',price:12.12,base:false,series:'Promos MEP 064–081'},
  {n:'066',name:'Tyrantrum',type:'Lutador',color:'#795548',rare:'Promo (Staff)',price:16.30,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'070',name:'Tyrunt',type:'Lutador',color:'#795548',rare:'Promo (Pokémon Center)',price:21.90,base:false,series:'Promos MEP 064–081'},
  {n:'071',name:'Mega Zygarde ex',type:'Lutador',color:'#795548',rare:'Promo (Jumbo)',price:13.99,base:false,important:true,series:'Promos MEP 064–081'},
  {n:'072',name:'Mega Clefable ex',type:'Psíquico',color:'#9C27B0',rare:'Promo (Jumbo)',price:23.00,base:false,important:true,series:'Promos MEP 064–081'},
  {n:'073',name:'Mega Gengar ex',type:'Escuridão',color:'#212121',rare:'Promo (Jumbo)',price:34.99,base:false,important:true,series:'Promos MEP 064–081'},
  {n:'074',name:'Delphox',type:'Fogo',color:'#F44336',rare:'Promo (B&B)',price:18.99,base:false,series:'Promos MEP 064–081'},
  {n:'075',name:'Ampharos',type:'Raio',color:'#FFC107',rare:'Promo (B&B)',price:12.60,base:false,series:'Promos MEP 064–081'},
  {n:'076',name:'Crobat',type:'Escuridão',color:'#212121',rare:'Promo (B&B)',price:17.75,base:false,series:'Promos MEP 064–081'},
  {n:'077',name:'Goodra',type:'Dragão',color:'#7C4DFF',rare:'Promo (B&B)',price:16.34,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'080',name:'Fennekin',type:'Fogo',color:'#F44336',rare:'Promo',price:29.70,base:false,series:'Promos MEP 064–081'},
  ...
  {n:'081',name:'Mega Greninja ex',type:'Aquático',color:'#2196F3',rare:'Promo (Jumbo)',price:35.00,base:false,important:true,series:'Promos MEP 064–081'},
  ...
  {n:'082',name:'Miraidon',type:'Raio',color:'#FFC107',rare:'Promo (Jumbo)',price:29.00,base:false,important:true,series:'Promos MEP 082–110'},
  ...
  {n:'088',name:'Zarude',type:'Escuridão',color:'#212121',rare:'Promo (Pokémon Center)',price:24.90,base:false,series:'Promos MEP 082–110'},
